...
export function ActivityWeekStrip({ selectedDate, days, onSelectDate, onPreviousWeek, onNextWeek }) {
  return (
    <View>
      <View style={styles.monthRow}>
        ...
        <View style={styles.weekActions}>
          ...
          <Pressable
            ...
            style={({ pressed }) => [styles.weekButton, pressed && styles.pressed]}
          >
            <Text style={styles.weekButtonText}>Siguiente</Text>
          </Pressable>
        </View>
      </View>
    ...
    <View style={[styles.card, { borderLeftColor: status.accent }]}>
      ...
      >
        ...
        <View style={styles.cardBody}>
          ...
          <Text numberOfLines={1} style={styles.cardMeta}>{classType}</Text>
          <Text numberOfLines={1} style={styles.cardMeta}>{teacher}</Text>
          <View style={styles.statusRow}>
            ...
            <Text style={styles.capacity}>{reserved}/{capacity} plazas</Text>
          </View>
        </View>
      </Pressable>
...
const styles = StyleSheet.create({
  ...
  cardTitle: { flex: 1, color: '#f7f7f8', fontSize: 19, lineHeight: 23, fontWeight: '900', textTransform: 'uppercase' },
  cardTime: { color: '#f7f7f8', fontSize: 16, lineHeight: 22, fontWeight: '900', textAlign: 'right' },
  cardMeta: { color: '#96969b', fontSize: 14, lineHeight: 21, fontWeight: '600', textTransform: 'uppercase' },
  statusRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 10, marginTop: 12 },
  ...
  capacity: { color: '#8e8e93', fontSize: 12, fontWeight: '800' },
  ...
  actionText: { color: '#ffffff', fontSize: 13, fontWeight: '900', textAlign: 'center' },
