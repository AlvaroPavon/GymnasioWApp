...
const styles = StyleSheet.create({
  ...
  filterButtonActive: { borderWidth: 1, borderColor: '#f4a621' },
  ...
  action: { flex: 1, minHeight: 48, borderRadius: 24, backgroundColor: '#f4a621', alignItems: 'center', justifyContent: 'center', paddingHorizontal: 14 },
