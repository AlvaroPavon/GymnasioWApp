    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        >
          ...
          <h2 className="text-2xl font-bold mb-6 text-red-500">Alta de Nuevo Miembro</h2>
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {isCameraActive ? (
                <div className="flex flex-col items-center space-y-4 w-full">
                  ...
                  <div className="flex gap-4 w-full justify-center">
                    <button type="button" onClick={capturePhoto} disabled={isCapturing} className="bg-red-400 hover:bg-red-300 text-[#19120a] font-bold py-2 px-6 rounded shadow-lg shadow-red-500/10 transition-colors">
                  ...
                  {file ? (
                    ...
                    <div className="text-center space-y-3">
                      ...
                      <div className="flex gap-2 justify-center mt-2">
                        <button type="button" onClick={startCamera} className="bg-red-500 hover:bg-red-400 text-white text-xs font-bold py-2 px-4 rounded transition-colors">
                          📷 Usar Cámara
                        </button>
            ...
            <button type="submit" disabled={loading || isCameraActive} className="md:col-span-2 mt-2 bg-red-500 hover:bg-red-400 disabled:opacity-50 text-white font-bold p-3 rounded-lg shadow-lg transition-colors">
